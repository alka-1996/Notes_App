...
setEditMode(false)
  ...
  return (
    <div className="App dark">
      ...
      <AddNote addNote={addNote} editMode={editMode} noteToBeEditted={noteToBeEditted} updateNote={updateNote}></AddNote>
      <div>
        {notes.map(note=>
        <Note key={note.id} id={note.id} priority={note.priority} text={note.text} editNote={editNote} deleteNote={deleteNote} ></Note>)}
      </div>
    </div>
  );
}
